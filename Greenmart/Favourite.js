    ...
    return (
        <View style={styles.cartItem}>
            ...
            <View style={styles.productInfo}>
                ...
                <Text style={{marginBottom:15,}}> 1kg, Price</Text>
            </View>
            ...
            <TouchableOpacity style={styles.removeButton} onPress={() => onRemove(item.id)}>
                <Text style={{fontSize:25,marginBottom:5,}} > lon hon </Text>
            </TouchableOpacity>
        </View>
    );
};
...
// Add more items as needed
    ...
    return (
        <View style={styles.container}>
            <Text style={styles.cartTitle}>Favorurite</Text>
            ...
            <TouchableOpacity style={styles.checkoutButton}>
                <Text style={styles.btnCheckOut}>Add All To Cart</Text>
